...
export default function UmowaOPraceScreen({ navigation, route }) {
  ...
  const handleSave = () => {
    console.log('Saving Umowa o Pracę:', { category, document, formData });
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.title}>Umowa o Pracę</Text>
      ...
      <TextInput
        ...
        onChangeText={(text) => handleInputChange('contractType', text)}
        mode="outlined"
        style={styles.input}
        theme={{ colors: { primary: '#001426FF' } }}
      />
